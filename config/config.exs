...
config :auth_me, AuthMe.UserManager.Guardian,
  issuer: "auth_me",
  secret_key: "sNzaVhQAfz04I396yXCNNIhmYOr50ZsUdh3S+dNxTp9qvZ8d34VQmLYlva89Jxiq"

# Configures the endpoint
config :auth_me, AuthMeWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "NclYaIM4/PcHxsdyXkTnUcvvKIAYG0kr//r6c1YJmL0RzXszRXkjBE/b+KXQzRvb",
  render_errors: [view: AuthMeWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: AuthMe.PubSub,
  live_view: [signing_salt: "ljhfK9GS"]
